//used code from https://github.com/zhemao/interrupt_example/blob/master/software/kernel/fpga_uinput.c
...
static irqreturn_t fpga_uinput_interrupt(int irq, void *dev_id)
{
	...
	uint8_t st = *(uint8_t *)fpga_uinput_mem;
